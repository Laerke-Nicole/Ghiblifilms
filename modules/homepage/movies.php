...
<section class="pt-16 pb-24 movies-container">   
        ...
        <div class="swiper-wrapper">
            <?php foreach ($getMovies as $getMovie): ?>
                <div class="swiper-slide">
                    <img src='upload/<?php echo htmlspecialchars(trim($getMovie['MovieImg'])); ?>' alt='Image of movie' class="round-corner movie-img pb-2">
