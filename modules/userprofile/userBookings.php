    ...
    <?php else: 
        ...
        foreach ($getUserReservations as $reservation): ?>
            <div>
                ...
                <br/>
                <td><a href="index.php?page=controllerdelete&table=Reservation&primaryKey=ReservationID&primaryKeyValue=<?php echo htmlspecialchars(trim($reservation['ReservationID'])) . '&UserID=' . $userID; ?>&redirect=userprofile"class="waves-effect waves-light btn-two red" onclick="return confirm('Cancel! Are you sure?')">Cancel booking</a></td>
                <br/>
                <br/>
                <br/>
            </div>
