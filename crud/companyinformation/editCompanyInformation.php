...
<div class="container">
        ...
        <form class="col s12" name="contact" method="post" action="controllers/update.php">
            ...
            <input type="hidden" name="original_CompanyInformationID" value="<?php echo htmlspecialchars($companyInformationID); ?>">
            ...
            <div class="row">
                <div class="input-field col s6">
                    <input id="StreetName" name="fk_Address_StreetName" type="text" value="<?php echo htmlspecialchars($getCompanyInformation[0][6]); ?>" class="validate" required="" aria-required="true">
                    <label for="StreetName">Street Name</label>
                </div>

                <div class="input-field col s6">
                    <input id="StreetNumber" name="fk_Address_StreetNumber" type="text" value="<?php echo htmlspecialchars($getCompanyInformation[0][7]); ?>" class="validate" required="" aria-required="true">
            ...
            <div class="row">
                <div class="input-field col s6">
                    <input id="PostalCode" name="fk_Address_PostalCode" type="text" value="<?php echo htmlspecialchars($getCompanyInformation[0][8]); ?>" class="validate" required="" aria-required="true">
                    <label for="PostalCode">Postal code</label>
                </div>

                <div class="input-field col s6">
                    <input id="Country" name="fk_Address_Country" type="text" value="<?php echo htmlspecialchars($getCompanyInformation[0][9]); ?>" class="validate" required="" aria-required="true">
